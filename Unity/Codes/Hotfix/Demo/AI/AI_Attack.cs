...
namespace ET
{
    ...
    {
        public override int Check(AIComponent aiComponent, cfg.AIConfig aiConfig)
        {
        ...
        public override async ETTask Execute(AIComponent aiComponent, cfg.AIConfig aiConfig, ETCancellationToken cancellationToken)
        {
