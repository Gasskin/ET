...
public sealed partial class Item :  Bright.Config.BeanBase 
{
    ...
    public Item(int id, string name, string desc, int price, int upgrade_to_item_id, long? expire_time, bool batch_useable, item.ItemExchange exchange_stream, System.Collections.Generic.List<item.ItemExchange> exchange_list, item.ItemExchange exchange_column ) 
    {
        this.Id = id;
        this.Name = name;
        this.Desc = desc;
